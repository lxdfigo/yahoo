...
mxUtils = {
    ...
    findNodeByAttribute: function() {
        ...
        function(a, b, c) {
            var d = null;
            if (a != null) if (a.nodeType == mxConstants.NODETYPE_ELEMENT && a.getAttribute(b) == c) d = a;
    ...
    getXml: function(a, b) {
        var c = "";
        window.XMLSerializer != null ? c = (new XMLSerializer).serializeToString(a) : a.xml != null && (c = a.xml.replace(/\r\n\t[\t]*/g, "").replace(/>\r\n/g, ">").replace(/\r\n/g, "\n"));
        return c = c.replace(/\n/g, b || "&#xa;")
    },
    ...
    arcToCurves: function(a, b, c, d, e, f, g, h, k) {
        ...
        if (r > 1) {
            ...
            r = 1;
            f === g && (r = -1);
            f = r * Math.sqrt((p * q - p * o - q * l) / (p * o + q * l))
        }
        l = f * c * i / d;
        o = -1 * f * d * e / c;
        h = m * l - n * o + h / 2;
        ...
        g = Math.ceil(g < 0 ? -1 * g: g), e = e / g, i = 8 / 3 * Math.sin(e / 4) * Math.sin(e / 4) / Math.sin(e / 2), l = m * c, m = m * d, c = n * c, d = n * d, u = Math.cos(f), v = Math.sin(f), o = -i * (l * v + d * u), p = -i * (c * v - m * u), r = q = 0, n = [], w = 0; w < g; ++w) {
            var f = f + e,
            u = Math.cos(f),
            v = Math.sin(f),
            q = l * u - d * v + h,
    ...
    intersectsHotspot: function(a, b, c, d, e, f) {
        ...
        if (d > 0) {
            ...
            k = a.width,
            i = a.height,
            l = mxUtils.getValue(a.style, mxConstants.STYLE_STARTSIZE) * a.view.scale;
    ...
    getSizeForString: function(a, b, c, d) {
        ...
        e.style.fontSize = (b || mxConstants.DEFAULT_FONTSIZE) + "px";
        e.style.fontFamily = c || mxConstants.DEFAULT_FONTFAMILY;
    ...
    this.shapes.connector = {
        ...
        drawShape: function(b, c, d, e, f) {
            if (e) {
                ...
                b.setDashed(false);
                d = c.absolutePoints.slice();
                this.translatePoint(d, 0, a.drawMarker(b, c, true));
                this.translatePoint(d, d.length - 1, a.drawMarker(b, c, false));
                b.setDashed(mxUtils.getValue(c.style, mxConstants.STYLE_DASHED, "0") == "1");
                b.begin();
                var g = d[0];
                b.moveTo(g.x, g.y);
                if (mxUtils.getValue(c.style, mxConstants.STYLE_CURVED, false)) {
                    e = d.length;
                    for (c = 1; c < e - 2; c++) {
                        var f = d[c],
                        h = d[c + 1];
                        b.quadTo(f.x, f.y, (f.x + h.x) / 2, (f.y + h.y) / 2)
                    }
                    f = d[e - 2];
                    h = d[e - 1];
                    b.quadTo(f.x, f.y, h.x, h.y)
                } else {
                    e = mxUtils.getValue(c.style, mxConstants.STYLE_ROUNDED, false);
                    f = mxConstants.LINE_ARCSIZE / 2;
                    h = d[d.length - 1];
                    b.moveTo(g.x, g.y);
                    for (c = 1; c < d.length - 1; c++) {
                        var k = d[c],
                        i = g.x - k.x,
                        g = g.y - k.y;
                        if (e && c < d.length - 1 && (i != 0 || g != 0)) {
                            var l = Math.sqrt(i * i + g * g),
                            i = i * Math.min(f, l / 2) / l,
                            g = g * Math.min(f, l / 2) / l;
...
var mxXmlCanvas2D = function(a) {
    ...
    return {
        ...
        image: function(c, d, f, g, n, o, p, q) {
            var n = b.convert(n),
            r = e.createElement("image");
            r.setAttribute("x", h(c));
            r.setAttribute("y", h(d));
            r.setAttribute("w", h(f));
            r.setAttribute("h", h(g));
            r.setAttribute("src", n);
            r.setAttribute("aspect", o ? "1": "0");
            r.setAttribute("flipH", p ? "1": "0");
            r.setAttribute("flipV", q ? "1": "0");
            a.appendChild(r)
        },
        text: function(b, c, f, g, n, o, p, q, r, u) {
            if (d) {
    ...
    return {
        ...
        rotate: function(a, b, c, d, e) {
            ...
            if (b ^ c) {
                ...
                g = c ? e: 0,
                c = c ? -1 : 1;
                i.transform = i.transform + ("translate(" + s(f) + "," + s(g) + ")");
                i.transform = i.transform + ("scale(" + s(b) + "," + s(c) + ")");
                i.transform = i.transform + ("translate(" + s( - f) + " " + s( - g) + ")")
            }
            i.transform = i.transform + ("rotate(" + s(a) + "," + s(d) + "," + s(e) + ")")
        },
        ...
        rect: function(a, c, e, f) {
            ...
            c = c + i.dy;
            n = g("rect");
            n.setAttribute("x", s(a * i.scale));
            n.setAttribute("y", s(c * i.scale));
            n.setAttribute("width", s(e * i.scale));
            n.setAttribute("height", s(f * i.scale)); ! b && d && n.setAttribute("shape-rendering", "crispEdges")
        },
        roundrect: function(a, c, e, f, h, k) {
            ...
            n.setAttribute("y", s(c * i.scale));
            n.setAttribute("width", s(e * i.scale));
            n.setAttribute("height", s(f * i.scale));
            h > 0 && n.setAttribute("rx", s(h * i.scale));
            k > 0 && n.setAttribute("ry", s(k * i.scale)); ! b && d && n.setAttribute("shape-rendering", "crispEdges")
        },
        ellipse: function(a, b, c, d) {
            a = a + i.dx;
            b = b + i.dy;
            n = g("ellipse");
            n.setAttribute("cx", s((a + c / 2) * i.scale));
            n.setAttribute("cy", s((b + d / 2) * i.scale));
            n.setAttribute("rx", s(c / 2 * i.scale));
            n.setAttribute("ry", s(d / 2 * i.scale))
        },
        image: function(b, d, e, f, h, k, l, m) {
            ...
            d = d + i.dy,
            n = g("image");
            n.setAttribute("x", s(b * i.scale));
            n.setAttribute("y", s(d * i.scale));
            n.setAttribute("width", s(e * i.scale));
            n.setAttribute("height", s(f * i.scale));
        ...
        text: function(c, d, h, k, l, m, n, o, p, q) {
            if (e) {
                ...
                if (f && q == "html") {
                    ...
                    if (o) {
                        o = d + k / 2;
                        r = r + ("rotate(-90," + s((c + h / 2) * i.scale) + "," + s(o * i.scale) + ")")
                    }
                    r.length > 0 && p.setAttribute("transform", r);
                    i.alpha < 1 && p.setAttribute("opacity", i.alpha);
        ...
        moveTo: function(a, b) {
            if (o != null) {
                a = a + i.dx;
                b = b + i.dy;
                o.push("M " + s(a * i.scale) + " " + s(b * i.scale));
                d && (p = new mxPoint(a, b))
            }
        },
        lineTo: function(a, b) {
            if (o != null) {
                a = a + i.dx;
                b = b + i.dy;
                o.push("L " + s(a * i.scale) + " " + s(b * i.scale));
                if (d) {
        ...
        quadTo: function(a, b, c, d) {
            if (o != null) {
                ...
                c = c + i.dx;
                d = d + i.dy;
                o.push("Q " + s(a * i.scale) + " " + s(b * i.scale) + " " + s(c * i.scale) + " " + s(d * i.scale));
                l = false
            }
        },
        curveTo: function(a, b, c, d, e, f) {
            if (o != null) {
                ...
                e = e + i.dx;
                f = f + i.dy;
                o.push("C " + s(a * i.scale) + " " + s(b * i.scale) + " " + s(c * i.scale) + " " + s(d * i.scale) + " " + s(e * i.scale) + " " + s(f * i.scale));
                l = false
            }
        },
        close: function() {
...
mxGuide.prototype.move = function(a, b, c) {
    if (this.states != null && (this.horizontal || this.vertical) && a != null && b != null) {
        ...
        for (var n = i.x,
        o = i.x + i.width,
        p = i.getCenterX(), q = i.y, r = i.y + i.height, u = i.getCenterY(), b = function(b) {
...
mxShape.prototype.configureSvgShape = function(a) {
    ...
    } else a.nodeName == "ellipse" && mxClient.IS_NS && !mxClient.IS_GC && !mxClient.IS_SF ? a.setAttribute("fill", "transparent") : a.setAttribute("fill", "none");
...
mxShape.prototype.createCurvedPoints = function(a) {
    for (var b = this.crisp && this.dialect == mxConstants.DIALECT_SVG && mxClient.IS_IE ? 0.5 : 0, c = a ? this.bounds.x: 0, d = a ? this.bounds.y: 0, e = this.points[0], f = this.points.length, g = (a ? "m": "M") + " " + (Math.round(e.x - c) + b) + " " + (Math.round(e.y - d) + b) + " ", h = 0, k = 0, i = 1; i < f - 2; i++) {
        var e = this.points[i],
        l = this.points[i + 1],
        h = (e.x + l.x) / 2,
        k = (e.y + l.y) / 2;
        if (a) {
            l = this.points[i - 1];
            g = g + this.createVmlQuad(l.x - c, l.y - d, e.x - c, e.y - d, h - c, k - d)
        } else g = g + ("Q " + Math.round(e.x - c) + " " + Math.round(e.y - d) + " " + (Math.round(h - c) + b) + " " + (Math.round(k - d) + b) + " ")
    }
    e = this.points[f - 2];
    l = this.points[f - 1];
    return g = a ? g + this.createVmlQuad(h - c, k - d, e.x - c, e.y - d, l.x - c, l.y - d) : g + ("Q " + Math.round(e.x - c) + " " + Math.round(e.y - d) + " " + (Math.round(l.x - c) + b) + " " + (Math.round(l.y - d) + b) + " ")
};
mxShape.prototype.createVmlQuad = function(a, b, c, d, e, f) {
    var b = b + 2 / 3 * (d - b),
    g = e + 2 / 3 * (c - e),
    d = f + 2 / 3 * (d - f);
    return "C " + Math.round(a + 2 / 3 * (c - a)) + " " + Math.round(b) + " " + Math.round(g) + " " + Math.round(d) + " " + Math.round(e) + " " + Math.round(f)
};
...
mxShape.prototype.updateVmlShape = function(a) {
    ...
    if (this.points != null && a.nodeName != "group") if (a.nodeName == "polyline" && a.points != null) {
        ...
        b = this.style == null || this.style[mxConstants.STYLE_CURVED] != 1 ? this.createPoints("m", "l", "c", true) : this.createCurvedPoints(true);
        a.path = b + " e"
    }
};
...
mxShape.prototype.updateSvgPath = function(a) {
    var b = this.style == null || this.style[mxConstants.STYLE_CURVED] != 1 ? this.createPoints("M", "L", "C", false) : this.createCurvedPoints(false);
    if (b != null) {
        a.setAttribute("d", b);
        a.removeAttribute("x");
        a.removeAttribute("y");
...
mxStencil.prototype.evaluateTextAttribute = function(a, b, c) {
    ...
    if (mxStencil.defaultLocalized && a == null || a == "1") b = mxResources.get(b);
    return b
};
...
mxStencil.prototype.renderDom = function(a, b, c, d) {
    ...
    if (this.bgNode != null || this.fgNode != null) {
        ...
        if (this.aspect == "fixed") {
            m = n = Math.min(m, n);
            if (h) {
                r = r + (b.height - this.w0 * m) / 2;
                u = u + (b.width - this.h0 * n) / 2
            } else {
                r = r + (b.width - this.w0 * m) / 2;
        ...
        B = function(b, c) {
            ...
            if (e) {
                ...
                if (c.fill != null) {
                    ...
                    a.updateVmlFill(f, c.fill, d, a.gradientDirection, c.alpha * 100);
                    b.appendChild(f)
                } else b.filled = "false";
                if (c.stroke != null) {
                    b.stroked = "true";
        ...
        C = function(d) {
            ...
            if (g == "save") {
                w.push(s);
                s = mxUtils.clone(s)
            } else if (g == "restore") s = w.pop();
            else if (g == "path") {
                y = [];
                if (e) {
                    t = document.createElement("v:shape");
                    B.call(this, t, s);
                    ...
                    t = document.createElementNS(mxConstants.NS_SVG, "path");
                    B.call(this, t, s);
                    l.length > 0 && t.setAttribute("transform", l);
                    d.getAttribute("crisp") == "1" && t.setAttribute("shape-rendering", "crispEdges")
                }
                ...
                if (e) {
                    z("e");
                    t.path = y.join("")
                } else t.setAttribute("d", y.join(""))
            } else if (g == "move") {
                h = e ? "m": "M";
                this.lastMoveX = x(r + Number(d.getAttribute("x")) * m);
                ...
                o = this.lastMoveY,
                i = r + Number(d.getAttribute("x1")) * m,
                g = u + Number(d.getAttribute("y1")) * n,
                k = r + Number(d.getAttribute("x2")) * m,
                ...
                this.lastMoveX = r + Number(d.getAttribute("x2")) * m;
                this.lastMoveY = u + Number(d.getAttribute("y2")) * n;
                z("Q " + (r + Number(d.getAttribute("x1")) * m) + " " + (u + Number(d.getAttribute("y1")) * n) + " " + this.lastMoveX + " " + this.lastMoveY)
            } else if (g == "curve") {
                h = e ? "c": "C";
                this.lastMoveX = x(r + Number(d.getAttribute("x3")) * m);
                this.lastMoveY = x(u + Number(d.getAttribute("y3")) * n);
                z(h + " " + x(r + Number(d.getAttribute("x1")) * m) + " " + x(u + Number(d.getAttribute("y1")) * n) + " " + x(r + Number(d.getAttribute("x2")) * m) + " " + x(u + Number(d.getAttribute("y2")) * n) + " " + this.lastMoveX + " " + this.lastMoveY)
            } else if (g == "close") z(e ? "x": "Z");
            else if (g == "rect" || g == "roundrect") {
                o = g == "roundrect";
                i = x(r + Number(d.getAttribute("x")) * m);
                ...
                if (e) {
                    t = document.createElement(o ? "v:roundrect": "v:rect");
                    t.style.left = i + "px";
                    t.style.top = h + "px";
                    t.style.width = k + "px";
                    t.style.height = g + "px";
                    o && t.setAttribute("arcsize", "" + p + "%")
                } else {
                    t = document.createElementNS(mxConstants.NS_SVG, "rect");
                    t.setAttribute("x", i);
                    t.setAttribute("y", h);
                    t.setAttribute("width", k);
                ...
                g = x(Number(d.getAttribute("h")) * n);
                if (e) {
                    t = document.createElement("v:arc");
                    t.startangle = "0";
                    t.endangle = "360";
                    t.style.left = i + "px";
                    t.style.top = h + "px";
                    ...
                    t = document.createElementNS(mxConstants.NS_SVG, "ellipse");
                    t.setAttribute("cx", i + k / 2);
                    t.setAttribute("cy", h + g / 2);
                    t.setAttribute("rx", k / 2);
                    t.setAttribute("ry", g / 2);
                    l.length > 0 && t.setAttribute("transform", l)
                }
                B.call(this, t, s)
            } else if (g == "arc") {
                ...
                if (o != null) {
                    ...
                    if (e) {
                        t = document.createElement("v:image");
                        t.style.filter = "alpha(opacity=" + s.alpha + ")";
                        t.style.left = i + "px";
                        t.style.top = h + "px";
                        t.style.width = k + "px";
                        t.style.height = g + "px";
                        t.src = o;
                        if (p && A) t.style.rotation = "180";
                        else if (p) t.style.flip = "x";
                        else if (A) t.style.flip = "y"
                    } else {
                        t = document.createElementNS(mxConstants.NS_SVG, "image");
                        t.setAttributeNS(mxConstants.NS_XLINK, "xlink:href", o);
                        t.setAttribute("opacity", s.alpha / 100);
                        t.setAttribute("x", i);
                        t.setAttribute("y", h);
                        t.setAttribute("width", k);
                        t.setAttribute("height", g);
                        ...
                        if (p || A) {
                            ...
                            t.setAttribute("transform", l + "scale(" + D + " " + E + ") translate(" + d + " " + o + ") ")
                        } else t.setAttribute("transform", l)
                    }
                    c.appendChild(t)
                }
                ...
                if (o != null) {
                    ...
                    o.renderDom(a, new mxRectangle(i, h, k, g), c, s)
                }
            } else if (g == "text") {
                k = this.evaluateTextAttribute(d, "str", a.state);
                if (k != null) {
                    i = x(r + Number(d.getAttribute("x")) * m);
                    h = x(u + Number(d.getAttribute("y")) * n);
                    ...
                    if (e) {
                        ...
                        d.style.fontSize = Math.round(s.fontSize / f) + "px";
                        d.style.fontFamily = s.fontFamily;
                        d.string = k;
                        d.on = "true";
                        if ((s.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD) d.style.fontWeight = "bold";
                        if ((s.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC) d.style.fontStyle = "italic";
                        if ((s.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE) d.style.textDecoration = "underline";
                        if (o == "top") t.style.top = h + s.fontSize / 2 + "px";
                        else if (o == "bottom") t.style.top = h - s.fontSize / 3 + "px";
                        t.appendChild(d)
                    } else {
                        t = document.createElementNS(mxConstants.NS_SVG, "text");
                        t.setAttribute("fill", s.fontColor);
                        t.setAttribute("font-family", s.fontFamily);
                        t.setAttribute("font-size", s.fontSize);
                        t.setAttribute("stroke", "none");
                        t.setAttribute("x", i);
                        t.appendChild(document.createTextNode(k)); (s.fontStyle & mxConstants.FONT_BOLD) == mxConstants.FONT_BOLD && t.setAttribute("font-weight", "bold"); (s.fontStyle & mxConstants.FONT_ITALIC) == mxConstants.FONT_ITALIC && t.setAttribute("font-style", "italic"); (s.fontStyle & mxConstants.FONT_UNDERLINE) == mxConstants.FONT_UNDERLINE && t.setAttribute("text-decoration", uline);
                        g == "left" ? g = "start": g == "center" ? g = "middle": g == "right" && (g = "end");
                        t.setAttribute("text-anchor", g);
                        if (o == "top") {
                            t.setAttribute("y", h + s.fontSize / 5);
                            t.setAttribute("dy", "1ex")
                        } else if (o == "middle") {
                            t.setAttribute("y", h + s.fontSize / 8);
                            t.setAttribute("dy", "0.5ex")
                        } else t.setAttribute("y", h);
                        l.length > 0 && t.setAttribute("transform", l)
                    }
                    c.appendChild(t)
                }
                ...
                if (t != null) {
                    g = null;
                    if (s.dashed) {
                        g = e ? v: Number(t.getAttribute("stroke-width"));
                        o = [];
                        for (d = 0; d < s.dashpattern.length; d++) o.push(Math.max(1, Math.round(Number(s.dashpattern[d]) * g)));
                        g = o.join(" ")
                    }
                    if (i || k) if (e) {
                        d = document.createElement("v:stroke");
                        d.endcap = s.linecap || "flat";
                        d.joinstyle = s.linejoin || "miter";
                        d.miterlimit = s.miterlimit || "10";
                        t.appendChild(d);
                        if (g != null) d.dashstyle = g
                    } else {
                        s.linejoin != null && t.setAttribute("stroke-linejoin", s.linejoin);
                        if (s.linecap != null) {
                            d = s.linecap;
                            d == "flat" && (d = "butt");
                            t.setAttribute("stroke-linecap", d)
                        }
                        s.miterlimit != null && t.setAttribute("stroke-miterlimit", s.miterlimit);
                        g != null && t.setAttribute("stroke-dasharray", g)
                    }
                    if (q && a.isShadow) {
                        ...
                        if (e) {
                            ...
                            s.fill != null && (h || k) ? p.setAttribute("fill", mxConstants.SHADOWCOLOR) : p.setAttribute("fill", "none");
                            p.setAttribute("transform", "translate(" + d + " " + o + ") " + (p.getAttribute("transform") || ""));
                            p.setAttribute("opacity", mxConstants.SHADOW_OPACITY);
                            c.appendChild(p)
                        }
                    }
                    if (h) e ? t.stroked = "false": t.setAttribute("stroke", "none");
                    else if (i) e ? t.filled = "false": t.setAttribute("fill", "none");
                    c.appendChild(t)
                }
                q && (q = false)
            } else if (g == "linecap") s.linecap = d.getAttribute("cap");
            else if (g == "linejoin") s.linejoin = d.getAttribute("join");
            else if (g == "miterlimit") s.miterlimit = d.getAttribute("limit");
            else if (g == "dashed") s.dashed = d.getAttribute("dashed") == "1";
            else if (g == "dashpattern") {
                d = d.getAttribute("pattern");
                if (d != null && d.length > 0) s.dashpattern = d.split(" ")
            } else if (g == "strokewidth") {
                h = d.getAttribute("fixed") == "1" ? 1 : v;
                s.strokeWidth = d.getAttribute("width") * h;
                if (e) s.strokeWidth = s.strokeWidth / f
            } else if (g == "strokecolor") s.stroke = d.getAttribute("color");
            else if (g == "fillcolor") {
                s.fill = d.getAttribute("color");
                s.fillColorAssigned = true
            } else if (g == "alpha") s.alpha = Number(d.getAttribute("alpha"));
            else if (g == "fontcolor") s.fontColor = d.getAttribute("color");
            else if (g == "fontsize") s.fontSize = Number(d.getAttribute("size")) * v;
            else if (g == "fontfamily") s.fontFamily = d.getAttribute("family");
            else if (g == "fontstyle") s.fontStyle = Number(d.getAttribute("style"))
        };
        if (!e) {
...
mxStencil.prototype.drawNode = function(a, b, c, d) {
    ...
    if (e == "save") a.save();
        ...
        b = this.evaluateTextAttribute(c, "str", b);
    ...
    else if (e == "strokewidth") {
        h = c.getAttribute("fixed") == "1" ? 1 : i;
        a.setStrokeWidth(Number(c.getAttribute("width")) * h)
...
mxDoubleEllipse.prototype.createSvg = function() {
    ...
    mxClient.IS_NS && !mxClient.IS_GC && !mxClient.IS_SF ? this.foreground.setAttribute("fill", "transparent") : this.foreground.setAttribute("fill", "none");
    a.appendChild(this.foreground);
    return a
};
...
function mxText(a, b, c, d, e, f, g, h, k, i, l, m, n, o, p, q, r, u, v, w) {
    this.value = a;
    this.bounds = b;
...
mxText.prototype.updateTableWidth = function(a) {
    ...
    b.style.whiteSpace = !this.wrap || this.bounds.width == 0 ? "nowrap": "normal"
};
...
mxSwimlane.prototype.redrawHtml = function() {
    ...
    this.node.style.background = "";
    this.node.style.backgroundColor = "";
    this.startSize = parseInt(mxUtils.getValue(this.style, mxConstants.STYLE_STARTSIZE, mxConstants.DEFAULT_STARTSIZE)) * this.scale;
    this.updateHtmlShape(this.label);
    this.label.style.top = "0px";
    this.label.style.left = "0px";
    if (mxUtils.getValue(this.style, mxConstants.STYLE_HORIZONTAL, true)) {
        var a = Math.round(this.startSize);
        this.startSize = Math.min(a, Math.round(this.bounds.height));
        this.label.style.height = this.startSize + "px";
        ...
        if (this.separator != null) {
            ...
            this.separator.style.top = Math.round(a) + "px";
        ...
        a = Math.round(this.startSize);
        this.startSize = Math.min(this.startSize, Math.round(this.bounds.width));
        this.label.style.width = this.startSize + "px";
        this.updateHtmlShape(this.content);
        this.content.style.background = "";
        this.content.style.backgroundColor = "";
...
mxStackLayout.prototype.execute = function(a) {
    if (a != null) {
        ...
        if (this.graph.isSwimlane(a)) {
            ...
            h = mxUtils.getValue(h, mxConstants.STYLE_HORIZONTAL, true) == 1;
            d != null && (k = h ? Math.min(k, d.height) : Math.min(k, d.width));
            b == h && (e = e - k);
            h ? g = g + k: f = f + k
        }
        c.beginUpdate();
        try {
            ...
            i = c.getChildCount(a), l = 0; l < i; l++) {
                ...
                if (!this.isVertexIgnored(m) && this.isVertexMovable(m)) {
                    ...
                    if (n != null) {
                        n = n.clone();
                        if (this.wrap != null && h != null && (b && h.x + h.width + n.width + 2 * this.spacing > this.wrap || !b && h.y + h.height + n.height + 2 * this.spacing > this.wrap)) {
                            h = null;
                            b ? g = g + (k + this.spacing) : f = f + (k + this.spacing);
                            k = 0
                        }
                        k = Math.max(k, b ? n.height: n.width);
                        if (h != null) b ? n.x = h.x + h.width + this.spacing: n.y = h.y + h.height + this.spacing;
                        else if (!this.keepFirstLocation) b ? n.x = f: n.y = g;
                        b ? n.y = g: n.x = f;
                        if (this.fill && e != null) b ? n.height = e: n.width = e;
                        c.setGeometry(m, n);
                        h = n
                    }
                }
            }
            if (this.resizeParent && d != null && h != null && !this.graph.isCellCollapsed(a)) {
                d = d.clone();
                b ? d.width = h.x + h.width + this.spacing: d.height = h.y + h.height + this.spacing;
                c.setGeometry(a, d)
            } else if (this.resizeLast && d != null && h != null) b ? h.width = d.width - h.x - this.spacing: h.height = d.height - h.y - this.spacing
        } finally {
            c.endUpdate()
        }
    }
...
mxCompactTreeLayout.prototype.sortOutgoingEdges = function(a, b) {
    ...
    b.sort(function(b, e) {
        var f = b.getTerminal(b.getTerminal(false) == a),
        g = c.get(f);
        if (g == null) {
            g = mxCellPath.create(f).split(mxCellPath.PATH_SEPARATOR);
            c.put(f, g)
        }
        var h = e.getTerminal(e.getTerminal(false) == a),
        k = c.get(h);
        if (k == null) {
            k = mxCellPath.create(h).split(mxCellPath.PATH_SEPARATOR);
            c.put(h, k)
        }
        mxLog.show();
        mxLog.debug("sort", f.value, b.value, g, h.value, e.value, k, mxCellPath.compare(g, k));
...
mxCompactTreeLayout.prototype.dfs = function(a, b, c) {
    ...
    if (a != null && c[d] == null && !this.isVertexIgnored(a)) {
        ...
        f = null,
        g = this.graph.getEdges(a, b, this.invert, !this.invert, false, true),
        ...
        for (a = 0; a < g.length; a++) {
            ...
            if (!this.isEdgeIgnored(k)) {
                ...
                var i = h.getState(k),
                k = i != null ? i.getVisibleTerminal(this.invert) : h.getVisibleTerminal(k, this.invert),
                i = this.dfs(k, b, c);
...
function mxGraphHierarchyModel(a, b, c, d, e) {
    ...
    for (d = 0; d < b.length; d++) {
        for (var e = c[d].connectsAsSource, f = 0; f < e.length; f++) {
            var g = e[f],
            h = g.edges;
            if (h != null && h.length > 0) {
                var h = h[0],
                k = a.getVisibleTerminal(h, false),
                k = mxCellPath.create(k),
                k = this.vertexMapper[k];
                if (c[d] == k) {
                    k = a.getVisibleTerminal(h, true);
                    k = mxCellPath.create(k);
                    k = this.vertexMapper[k]
                }
                if (k != null && c[d] != k) {
                    ...
                    mxUtils.indexOf(k.connectsAsTarget, g) < 0 && k.connectsAsTarget.push(g)
                }
            }
        }
        c[d].temp[0] = 1
...
mxGraphHierarchyModel.prototype.createInternalCells = function(a, b, c) {
    for (var d = a.getGraph(), e = 0; e < b.length; e++) {
        ...
        for (var g = 0; g < f.length; g++) {
            var h = a.getVisibleTerminal(f[g], false);
            if (h != b[e] && h != b[e] && a.graph.model.isVertex(h) && !a.isVertexIgnored(h)) {
                var k = a.getEdgesBetween(b[e], h, false),
                i = a.getEdgesBetween(b[e], h, true),
...
mxGraphHierarchyModel.prototype.initialRank = function() {
    var a = [];
    if (this.roots != null) for (var b = 0; b < this.roots.length; b++) {
    ...
    for (var e = a.slice(); a.length > 0;) {
        ...
        for (var h = true,
        k = this.SOURCESCANSTARTRANK,
        b = 0; b < f.length; b++) {
            var i = f[b];
            if (i.temp[0] == 5270620) {
                i = i.source;
                k = Math.min(k, i.temp[0] - 1)
            } else {
                h = false;
                break
            }
    ...
    for (b = 0; b < e.length; b++) {
        ...
        for (d = 0; d < f.length; d++) {
            i = f[d];
            i = i.target;
            c.temp[0] = Math.max(a, i.temp[0] + 1);
            a = c.temp[0]
        }
    }
...
mxMedianHybridCrossingReduction.prototype.transpose = function(a, b) {
    ...
    f = 0; f < b.ranks.length; f++) {
        ...
        k = 0; k < g.length - 1; k++) {
            ...
            for (w = 0; w < p.length; w++) for (y = 0; y < r.length; y++) {
                p[w] > r[y] && s++;
                p[w] < r[y] && t++
            }
            if (t < s || t == s && e) {
...
mxCoordinateAssignment.prototype.minNode = function(a) {
    ...
    for (f = 0; b.length > 0 && f <= a;) {
        ...
        q = m + n,
        r = e.getGeneralPurposeVariable(k),
        u = r;
        q > 0 && (u = (o * m + p * n) / q);
        m = false;
        if (u < r - 1) if (i == 0) {
            ...
            i = d[k][i - 1];
            r = i.getGeneralPurposeVariable(k);
            r = r + i.width / 2 + this.intraCellSpacing + e.width / 2;
            if (r < u) {
                e.setGeneralPurposeVariable(k, u);
                m = true
            } else if (r < e.getGeneralPurposeVariable(k) - 1) {
                e.setGeneralPurposeVariable(k, r);
                m = true
            }
        } else if (u > r + 1) if (i == d[k].length - 1) {
            e.setGeneralPurposeVariable(k, u);
            m = true
        } else {
            i = d[k][i + 1];
...
mxCoordinateAssignment.prototype.setCellLocations = function(a, b) {
    ...
    this.layout.resizeParent && c != null && this.adjustParents(c); (this.edgeStyle == mxHierarchicalEdgeStyle.ORTHOGONAL || this.edgeStyle == mxHierarchicalEdgeStyle.POLYLINE || this.edgeStyle == mxHierarchicalEdgeStyle.CURVE) && this.localEdgeProcessing(b);
...
mxCoordinateAssignment.prototype.setEdgePosition = function(a) {
    ...
    if (a.temp[0] != 101207) {
        ...
        for (var e = 0,
        f = this.jettyPositions[mxCellPath.create(a.edges[0])], g = a.isReversed ? a.target.cell: a.source.cell, h = this.layout.graph, k = 0; k < a.edges.length; k++) {
            var i = a.edges[k],
            l = this.layout.getVisibleTerminal(i, true),
            m = h.model.getTerminal(i, true),
            n = [],
            o = a.isReversed;
            l != g && (o = !o);
            if (f != null) {
                var p = o ? 2 : 0,
                q = o ? this.rankTopY[d] : this.rankBottomY[c],
                r = f[e * 4 + 1 + p];
                o && (r = -r);
                q = q + r;
                p = f[e * 4 + p];
                m = h.model.getTerminal(i, true);
                if (this.layout.isPort(m) && h.model.getParent(m) == l) {
                    p = h.view.getState(m);
                    p = p != null ? p.x: l.geometry.x + a.source.width * m.geometry.x
                }
                if (this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH) {
                    n.push(new mxPoint(p, q));
                    this.edgeStyle == mxHierarchicalEdgeStyle.CURVE && n.push(new mxPoint(p, q + r))
                } else {
                    n.push(new mxPoint(q, p));
                    this.edgeStyle == mxHierarchicalEdgeStyle.CURVE && n.push(new mxPoint(q + r, p))
                }
            }
            p = a.x.length - 1;
            q = r = -1;
            ...
            for (; a.maxRank != a.minRank && p != r; p = p + q) {
                var m = a.x[p] + b,
                u = (this.rankTopY[l] + this.rankBottomY[l + 1]) / 2,
                v = (this.rankTopY[l - 1] + this.rankBottomY[l]) / 2;
                if (o) var w = u,
                u = v,
                v = w;
                if (this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH) {
                    n.push(new mxPoint(m, u));
                    n.push(new mxPoint(m, v))
                } else {
                    n.push(new mxPoint(u, m));
                    n.push(new mxPoint(v, m))
                }
                this.limitX = Math.max(this.limitX, m);
                l = l + q
            }
            if (f != null) {
                p = o ? 2 : 0;
                q = o ? this.rankBottomY[c] : this.rankTopY[d];
                r = f[e * 4 + 3 - p];
                o && (r = -r);
                q = q - r;
                p = f[e * 4 + 2 - p];
                o = h.model.getTerminal(i, false);
                l = this.layout.getVisibleTerminal(i, false);
                if (this.layout.isPort(o) && h.model.getParent(o) == l) {
                    p = h.view.getState(o);
                    p = p != null ? p.x: l.geometry.x + a.target.width * o.geometry.x
                }
                if (this.orientation == mxConstants.DIRECTION_NORTH || this.orientation == mxConstants.DIRECTION_SOUTH) {
                    this.edgeStyle == mxHierarchicalEdgeStyle.CURVE && n.push(new mxPoint(p, q - r));
                    n.push(new mxPoint(p, q))
            ...
            a.isReversed && this.processReversedEdge(a, i);
            this.layout.setEdgePoints(i, n);
    ...
    if (a != null && b != null) {
        ...
        for (g in b) {
            ...
            if (d.isVertex(h) && this.graph.isCellVisible(h)) {
                for (var k = this.getEdges(h), i = 0, l = 0, m = 0; m < k.length; m++) this.getVisibleTerminal(k[m], true) == h ? i++:l++;
                l == 0 && i > 0 && c.push(h);
                k = i - l;
                if (k > f) {
                    f = k;
        ...
        c.length == 0 && e != null && c.push(e)
    }
    return c
};
mxHierarchicalLayout.prototype.getEdges = function(a) {
    var b = mxCellPath.create(a);
    if (this.edgesCache[b] != null) return this.edgesCache[b];
    for (var c = this.graph.model,
    d = [], e = this.graph.isCellCollapsed(a), f = c.getChildCount(a), g = 0; g < f; g++) {
        var h = c.getChildAt(a, g);
        if (this.isPort(h)) d = d.concat(c.getEdges(h, true, true));
        else if (e || !this.graph.isCellVisible(h)) d = d.concat(c.getEdges(h, true, true))
    }
    d = d.concat(c.getEdges(a, true, true));
    c = [];
    for (g = 0; g < d.length; g++) {
        e = this.getVisibleTerminal(d[g], true);
        f = this.getVisibleTerminal(d[g], false); (e == f || e != f && (f == a && (this.parent == null || this.graph.isValidAncestor(e, this.parent, this.traverseAncestors)) || e == a && (this.parent == null || this.graph.isValidAncestor(f, this.parent, this.traverseAncestors)))) && c.push(d[g])
    }
    return this.edgesCache[b] = c
};
mxHierarchicalLayout.prototype.getVisibleTerminal = function(a, b) {
    var c = this.graph.view.getState(a),
    c = c != null ? c.getVisibleTerminal(b) : this.graph.view.getVisibleTerminal(a, b);
...
mxHierarchicalLayout.prototype.run = function(a) {
    var b = [],
    c = [];
    if (this.roots == null && a != null) {
        var d = {};
        this.filterDescendants(a, d);
        this.roots = [];
        var e = true,
        f;
        for (f in d) if (d[f] != null) {
            e = false;
            break
        }
        for (; ! e;) {
            for (var g = this.findRoots(a, d), e = 0; e < g.length; e++) {
                var h = {};
                b.push(h);
                this.traverse(g[e], true, null, c, h, b, d)
            }
    ...
    } else for (e = 0; e < this.roots.length; e++) {
        h = {};
        b.push(h);
        this.traverse(this.roots[e], true, null, c, h, b, null)
    }
...
mxHierarchicalLayout.prototype.isPort = function(a) {
    return a.geometry.relative ? true: false
};
mxHierarchicalLayout.prototype.getEdgesBetween = function(a, b, c) {
    for (var c = c != null ? c: false, d = this.getEdges(a), e = [], f = 0; f < d.length; f++) {
        var g = this.getVisibleTerminal(d[f], true),
        h = this.getVisibleTerminal(d[f], false); (g == a && h == b || !c && g == b && h == a) && e.push(d[f])
    }
    return e
};
mxHierarchicalLayout.prototype.traverse = function(a, b, c, d, e, f, g) {
    if (a != null && d != null) {
        ...
        if (d[h] == null && (g == null || g[h] != null)) {
            e[h] == null && (e[h] = a);
            d[h] == null && (d[h] = a);
            g !== null && delete g[h];
            for (var k = this.getEdges(a), c = 0; c < k.length; c++) {
                h = this.getVisibleTerminal(k[c], true) == a;
                if (!b || h) e = this.traverse(this.getVisibleTerminal(k[c], !h), b, k[c], d, e, f, g)
            }
        } else if (e[h] == null) for (c = 0; c < f.length; c++) {
            a = f[c];
            if (a[h] != null) {
                for (k in e) a[k] = e[k];
                f.pop();
...
mxGraphModel.prototype.beginUpdate = function() {
    ...
    this.updateLevel == 1 && this.fireEvent(new mxEventObject(mxEvent.START_EDIT))
};
mxGraphModel.prototype.endUpdate = function() {
    this.updateLevel--;
    this.updateLevel == 0 && this.fireEvent(new mxEventObject(mxEvent.END_EDIT));
...
mxPrintPreview.prototype.open = function(a) {
    ...
    try {
        ...
        if (this.wnd == null) {
            ...
            for (a = 0; a < n; a++) for (var s = a * l / this.scale - this.y0 / this.scale + (f.y - k.y * g) / g, e = 0; e < m; e++) {
                if (this.wnd == null) return null;
                h = a * m + e + 1;
                c = this.renderPage(this.pageFormat.width, this.pageFormat.height, -(e * i / this.scale - this.x0 / this.scale + (f.x - k.x * g) / g), -s, this.scale, h);
...
mxPrintPreview.prototype.renderPage = function(a, b, c, d, e) {
    ...
    try {
        ...
        try {
            var r = [this.getRoot()],
            a = new mxTemporaryCellStates(h, e, r)
        } finally {
...
mxCellEditor.prototype.init = function() {
    ...
    this.changeHandler = mxUtils.bind(this,
    function() {
        this.editingCell != null && this.graph.getView().getState(this.editingCell) == null && this.stopEditing(true)
    });
...
mxCellRenderer.prototype.defaultShapes[mxConstants.SHAPE_RECTANGLE] = mxImageShape;
mxCellRenderer.prototype.defaultShapes[mxConstants.SHAPE_ELLIPSE] = mxImageShape;
mxCellRenderer.prototype.defaultShapes[mxConstants.SHAPE_DOUBLE_ELLIPSE] = mxDoubleEllipse;
mxCellRenderer.prototype.defaultShapes[mxConstants.SHAPE_RHOMBUS] = mxImageShape;
...
mxCellRenderer.prototype.defaultShapes[mxConstants.SHAPE_SWIMLANE] = mxImageShape;
...
var mxEdgeStyle = {
    ...
    SideToSide: function(a, b, c, d, e) {
        ...
        if (b != null && c != null) {
            ...
            } ! mxUtils.contains(c, a, h) && !mxUtils.contains(b, a, h) && e.push(new mxPoint(a, h)); ! mxUtils.contains(c, a, f) && !mxUtils.contains(b, a, f) && e.push(new mxPoint(a, f));
    ...
    OrthConnector: function(a, b, c, d, e) {
        ...
        if (d != null && d.length > 0 || g || f) mxEdgeStyle.SegmentConnector(a, b, c, d, e);
            ...
            for (i = k = 0; i < q.length; i++) {
                ...
                var r = (q[i] & mxEdgeStyle.TARGET_MASK) > 0,
...
mxGraphView.prototype.destroy = function() {
    ...
    if (a != null && a.parentNode != null) {
        ...
        if (this.moveHandler != null) {
            mxEvent.removeListener(document, mxClient.IS_TOUCH ? "touchmove": "mousemove", this.moveHandler);
            this.moveHandler = null
        }
        if (this.endHandler != null) {
            mxEvent.removeListener(document, mxClient.IS_TOUCH ? "touchend": "mouseup", this.endHandler);
    ...
    if (!this.timerAutoScroll && (this.ignoreScrollbars || mxUtils.hasScrollbars(this.container))) {
        ...
        if (a >= e.scrollLeft && b >= e.scrollTop && a <= e.scrollLeft + e.clientWidth && b <= e.scrollTop + e.clientHeight) {
            ...
            if (f < d) {
                ...
                if (c && a == e.scrollLeft) {
                    if (this.dialect == mxConstants.DIALECT_SVG) var a = this.view.getDrawPane().ownerSVGElement,
...
mxGraph.prototype.postProcessCellStyle = function(a) {
    if (a != null) {
        ...
        if (c != null && c.substring(0, 11) == "data:image/") {
            if (c.substring(0, 19) != "data:image/svg+xml,") {
                b = c.indexOf(",");
...
mxGraph.prototype.handleGesture = function(a, b) {
    if (this.isEnabled() && this.isCellResizable(a.cell) && Math.abs(1 - b.scale) > 0.2) {
                ...
                if (g != null) {
                    ...
                    if (h != null && k != null) {
                        ...
                        if (p != null && this.isCellDisconnectable(a[e], p, false)) {
                            ...
                            if (p == null) {
                                var r = m.length - 1;
                                g.setTerminalPoint(new mxPoint(m[r].x / b - c.x + i, m[r].y / b - c.y + l), false);
...
mxGraph.prototype.fit = function(a, b) {
    if (this.container != null) {
        ...
        if (b) this.view.scale != c && this.view.setScale(c);
...
mxOutline.prototype.mouseUp = function(a, b) {
    if (this.active) {
        ...
        d = c.x,
        c = c.y;
        if (Math.abs(d) > 0 || Math.abs(c) > 0) {
            if (this.zoom) {
                var c = this.selectionBorder.bounds.width,
                e = this.source.getView().scale;
                this.source.zoomTo(e - d * e / c, false)
    ...
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        ...
        if (this.currentFocusArea == null || !mxUtils.intersects(this.currentFocusArea, d) || a.getState() != null && this.currentFocus != null && e) {
            ...
            if (a.getState() != this.currentFocus) {
                ...
                this.constraints = a.getState() != null && e && !this.isStateIgnored(a.getState(), b) ? this.graph.getAllConnectionConstraints(a.getState(), b) : null;
...
mxEdgeSegmentHandler.prototype.getPreviewPoints = function(a) {
    ...
    if (d.length == 1) {
        ...
        if (f != null & e != null) {
            ...
            if (mxUtils.contains(f, d[0].x + g, d[0].y + h)) b[1].y == b[2].y ? d[0].y = c.getRoutingCenterY(e) - h: d[0].x = c.getRoutingCenterX(e) - g;
            else if (mxUtils.contains(e, d[0].x + g, d[0].y + h)) b[1].y == b[0].y ? d[0].y = c.getRoutingCenterY(f) - h: d[0].x = c.getRoutingCenterX(f) - g
        }
    } else d.length == 0 && (d = [a]);
    return d
};
...
mxKeyHandler.prototype.keyDown = function(a) {
    if (this.graph.isEnabled() && !mxEvent.isConsumed(a) && this.isGraphEvent(a) && this.isEnabled()) if (a.keyCode == 27 || a.keyCode == 123) this.escape(a);
